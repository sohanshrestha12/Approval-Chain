...
namespace ApprovalChain.Migrations
{
    ...
    [Migration("20240506060613_Approval auth")]
            ...
            modelBuilder.Entity("ApprovalChain.Models.Approval", b =>
                {
                    ...
                    b.Property<string>("Approval_Email")
                        .IsRequired()
                    ...
                    b.Property<string>("Approval_Password")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ApprovalChain.Models.Documents", b =>
                {
                    ...
                    b.Property<string>("Reject_Review")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ApprovalChain.Models.DocumentApproval", b =>
                {
                    ...
                    b.HasOne("ApprovalChain.Models.Documents", "Document")
                        ...
                        .HasForeignKey("ApprovalChain.Models.DocumentApproval", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApprovalChain.Models.Documents", b =>
                {
                    ...
                    b.Navigation("DocumentRecommender");
                });
